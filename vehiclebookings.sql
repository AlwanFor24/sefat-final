...
(1, 'System Admin', 'admin@mail.com', 'admin123', '1227050017', NULL);
...
CREATE TABLE `tms_user` (
  ...
  `u_car_type` varchar(255) NULL DEFAULT 'Not Specified',
  `u_car_regno` varchar(255) NULL DEFAULT 'Not Specified',
  `u_car_bookdate` varchar(255) NULL DEFAULT 'Not Specified',
